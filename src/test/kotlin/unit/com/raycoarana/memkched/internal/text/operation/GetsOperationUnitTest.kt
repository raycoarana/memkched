...
internal class GetsOperationUnitTest : BaseOperationUnitTest<GetsResult<ByteArray>>() {
    @Test
    ...
    fun `gets key when value is found`() {
        ...
        thenOperationResultIs(GetsResult.Value(Flags().set(0), "abcde".toByteArray(Charsets.US_ASCII), CasUnique(27)))
    }
